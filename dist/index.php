...
<body>
                                        ...
                                        <table class="table table-striped" id="table1">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-success btn-sm icon" class="run-validation"><i class="fa fa-check"></i></button>
                                                        <button class="btn btn-danger btn-sm icon"><i class="fa fa-times"></i></button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
    ...
    <?php
    include('./assets/components/Modals/proof.php');
    ?>
